...
const AddDailyGoalsForm = ({ open, onClose, onAddDailyGoals, getProductivityData}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
        const response = await axios.post('http://localhost:3333/daily-goals', payload, {
            headers: {
      ...
      alert('Daily goals data added successfully!'); // Customize the alert as needed
    } catch (error) {
